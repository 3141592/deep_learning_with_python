...
print("10.3.1 A recurrent layer in keras")

#
# Listing 10.19 Stacking RNN layers
print("Listing 10.19 Stacking RNN layers")
from tensorflow import keras
...
callbacks = [
        ...
        keras.callbacks.ModelCheckpoint("jena_simplernn_cpu.keras",
            save_best_only=True)
]
...
model = keras.models.load_model("jena_simplernn_cpu.keras")
