...
print("10.4.3 Using bidirectional RNNs")

#
# Listing 10.24 Training and evaluating a bidirectional LSTM
print("Listing 10.24 Training and evaluating a bidirectional LSTM")
from tensorflow import keras
...
callbacks = [
        ...
        keras.callbacks.ModelCheckpoint("jena_bidirectional_lstm_cpu.keras",
            save_best_only=True)
]
...
model = keras.models.load_model("jena_bidirectional_lstm_cpu.keras")
